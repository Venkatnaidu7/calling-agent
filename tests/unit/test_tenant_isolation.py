...
class TestTenantIsolation:
    ...
    @pytest.mark.asyncio
    async def test_tenant_a_cannot_read_tenant_b_user(
        self, client: AsyncClient, user_a: User, user_b: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_tenant_b_cannot_list_tenant_a_users(
        self, client: AsyncClient, user_a: User, user_b: User
    ):
    ...
    @pytest.mark.asyncio
    async def test_tenant_a_cannot_modify_tenant_b_user(
        self, client: AsyncClient, user_a: User, user_b: User
    ):
