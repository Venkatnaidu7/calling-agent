...
class AuditService:
    ...
    async def log(self, tenant_id: UUID | None, user_id: UUID | None, action: str, resource_type: str, resource_id: UUID, details: Dict[str, Any] = None, ip: str = None) -> None:
    ...
    async def list_logs(self, tenant_id: UUID, pagination: PaginationParams, filters: dict = None) -> PaginatedResponse:
