...
from apps.api.schemas.contact import (
    ...
    ContactListMemberCreate, ContactListMemberResponse
)
...
async def list_contacts(
    ...
    user: Annotated[User, Depends(require_roles(["TENANT_OWNER", "TENANT_ADMIN", "CONTACT_MANAGER"]))]
):
...
@router.post("/lists/{list_id}/members", response_model=ContactListMemberResponse, status_code=status.HTTP_201_CREATED)
